...
class TestSplitNodesImage(unittest.TestCase):
    ...
    def test_one_image(self):
        ...
        self.assertEqual(new_nodes[1], TextNode("Cat", TextType.IMAGE, "https://placekitten.com/200/200"))
    ...
    def test_two_images(self):
        ...
        self.assertEqual(new_nodes[3], TextNode("Dog", TextType.IMAGE, "https://placedog.net/200/200"))
    ...
    def test_only_image(self):
        ...
        self.assertEqual(new_nodes[0], TextNode("Cat", TextType.IMAGE, "https://placekitten.com/200/200"))

    def test_two_images_no_space(self):
        node: TextNode = TextNode(
        ...
        self.assertEqual(len(new_nodes), 2)
        self.assertEqual(new_nodes[0], TextNode("Cat", TextType.IMAGE, "https://placekitten.com/200/200"))
        self.assertEqual(new_nodes[1], TextNode("Dog", TextType.IMAGE, "https://placedog.net/200/200"))
    ...
    def test_multiple_nodes(self):
        ...
        self.assertEqual(new_nodes[5], TextNode("Cat", TextType.IMAGE, "https://placekitten.com/200/200"))
        self.assertEqual(new_nodes[6], TextNode(", "))
        self.assertEqual(new_nodes[7], TextNode("Dog", TextType.IMAGE, "https://placedog.net/200/200"))
